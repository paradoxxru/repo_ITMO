    							...
    							<div class="catalog">
									<?php
										...
										foreach ($arr_goods as $id => $item) {
											//если кол-во товара в базе = 0, то класс для карточки товара установить с opacity, а класс для кнопки "добавить" display_none
											if($item['count'] == 0) {
												$item['class_catalog_item'] = "catalog__item opacity";
												$item['class_for_a'] = 'do-action display_none';
											} else {
												$item['class_catalog_item'] = "catalog__item";
